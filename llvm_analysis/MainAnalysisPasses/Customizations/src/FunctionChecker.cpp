...
#define DEBUG_HANDLE_FUNCTION
    ...
    void* FunctionHandler::handleFunction(InstLoc *callInstLoc, Function *targetFunction,
...
#endif
            is_handled = true;
            return callback->handleAllocationFunction(callInstLoc, targetFunction, private_data);
        }
...
#endif
            is_handled = true;
            return callback->handleCustomFunction(callInstLoc, targetFunction, private_data);
        }
