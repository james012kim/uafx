...
#define DEBUG_FUNCTION_PTR_ALIASING
    ...
    std::set<PointerPointsTo*>* PointsToUtils::getPointsToObjects(GlobalState &currState,
        ...
        return currState.getPointsToObjects(ctx, srcPointer);
    }
    ...
    bool PointsToUtils::hasPointsToObjects(GlobalState &currState,
         ...
         */
        std::set<PointerPointsTo*> *ptos = currState.getPointsToObjects(ctx, srcPointer);
        return (ptos && !ptos->empty());
    }

    bool PointsToUtils::getTargetFunctions(GlobalState &currState, CallContext *ctx,
        ...
        std::set<PointerPointsTo*>* basePointsTo = PointsToUtils::getPointsToObjects(currState, ctx,
                                                                                     srcPointer);
        if(basePointsTo == nullptr) {
            basePointsTo = PointsToUtils::getPointsToObjects(currState, ctx,
    ...
    bool PointsToUtils::getAllAliasObjects(GlobalState &currState, CallContext *ctx,
                            Value *srcPointer,
