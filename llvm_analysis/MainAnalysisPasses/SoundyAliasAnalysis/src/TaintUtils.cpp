...
namespace DRCHECKER {
    std::set<TaintFlag*>* TaintUtils::getTaintInfo(GlobalState &currState,
        ...
        std::map<Value *, std::set<TaintFlag*>*> *contextTaintInfo = currState.getTaintInfo(ctx);
    ...
    void TaintUtils::updateTaintInfo(GlobalState &currState,
                                     CallContext *ctx, Value *targetVal,
...
#endif
        std::set<TaintFlag*> *existingTaintInfo = TaintUtils::getTaintInfo(currState, ctx, targetVal);
    ...
    unsigned TaintUtils::getTaintState(GlobalState &currState,
        ...
        std::set<TaintFlag*>* taintFlags = TaintUtils::getTaintInfo(currState, ctx, targetVal);
