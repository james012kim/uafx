...
namespace DRCHECKER {
    ...
    private:
         ...
         */
        void updatePointsToObjects(Value *srcPointer, std::set<PointerPointsTo*> *newPointsToInfo, bool free = true);
        //This is a wrapper for the single pto case.
        void updatePointsToObjects(Value *p, AliasObject *obj, InstLoc *propInst = nullptr, long dfid = 0, bool is_weak = false, bool is_creation = false);
        /***
         ...
         */
        void setupCallContext(CallInst &I, Function *currFunction, CallContext *ctx);
        ...
        AliasObject *getObj4Copy(PointerPointsTo *pto, Type *ty, Instruction &I);

        PointerPointsTo *copyObj(Value *dstPointer, PointerPointsTo *srcPto,
                                 Type *ty, Instruction &propInst, bool createHeap = false);
        ...
        void markFreedObj(AliasObject *obj, Instruction &I, PointerPointsTo *pto);

        void markFreedObjs(std::vector<long> &freedArgs, CallInst &I);

        void _visitStoreInst(StoreInst &I);

        void _visitLoadInst(LoadInst &I);

        VisitorCallback* _visitCallInst(CallInst &I, Function *currFunc,
