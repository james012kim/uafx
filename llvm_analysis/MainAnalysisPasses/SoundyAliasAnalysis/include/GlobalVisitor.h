...
#define FUNC_BLOCKLIST
    ...
    public:
        ...
        virtual void visit(Instruction &I) {
            ...
            dbgs() << "GlobalVisitor::visit(): " << InstructionUtils::getValueStr(&I) << "\n";
#endif
    ...
    private:
        ...
        int _getCallTargets(CallInst &I, std::set<Function*> &tgts);

        bool _shouldSkipForPerf(Function *func);

#ifdef FUNC_BLOCKLIST
        static bool isFuncBlocked(std::string &fname);
#endif
    };
}
