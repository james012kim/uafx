...
namespace DRCHECKER {
    ...
    public:
        ...
        static std::map<std::string, std::vector<long>> free_function_arg_map;
        static std::map<std::string, std::vector<long>> lock_function_arg_map;
        static std::vector<std::string> lock_func_pair;
